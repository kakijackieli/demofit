...
#'
#' @export
PCFMS <- function(x,D1,D2,E1,E2,curve=NULL,h=10,jumpoff=1) {
...
#' @export
forecast.PCFMS <- function(object,which=1,...) .forecastCModel(object,which,...)
...
#' @export
residuals.PCFMS <- function(object,...) .residualsCModel(object,...)

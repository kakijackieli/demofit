...
#'
#' @export
PCBDCS <- function(x,D,E,curve=NULL,h=10,jumpoff=1) {
...
#' @export
forecast.PCBDCS <- function(object,which=1,...) .forecastModel(object,which,...)
...
#' @export
residuals.PCBDCS <- function(object,...) .residualsModel(object,...)

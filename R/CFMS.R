...
#'
#' @export
CFMS <- function(x,M1,M2,curve=NULL,h=10,jumpoff=1) {
...
#' @export
forecast.CFMS <- function(object,which=1,...) .forecastCModel(object,which,...)
...
#' @export
residuals.CFMS <- function(object,...) .residualsCModel(object,...)

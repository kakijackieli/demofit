...
#'
#' @export
RHS <- function(x,M,curve=NULL,h=10,jumpoff=1) {
.checkinput2(x,M,h)
...
#' @export
forecast.RHS <- function(object,which=1,...) .forecastModel(object,which,...)
...
#' @export
residuals.RHS <- function(object,...) .residualsModel(object,...)

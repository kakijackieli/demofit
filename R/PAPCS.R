...
#'
#' @export
PAPCS <- function(x,D,E,curve=NULL,h=10,jumpoff=1) {
...
#' @export
forecast.PAPCS <- function(object,which=1,...) .forecastModel(object,which,...)
...
#' @export
residuals.PAPCS <- function(object,...) .residualsModel(object,...)

...
#'
#' @export
CBDS <- function(x,M,curve=NULL,h=10,jumpoff=1) {
.checkinput2(x,M,h)
...
#' @export
forecast.CBDS <- function(object,which=1,...) .forecastModel(object,which,...)
...
#' @export
residuals.CBDS <- function(object,...) .residualsModel(object,...)

...
#'
#' @export
PCBDQCS <- function(x,D,E,curve=NULL,h=10,jumpoff=1) {
...
#' @export
forecast.PCBDQCS <- function(object,which=1,...) .forecastModel(object,which,...)
...
#' @export
residuals.PCBDQCS <- function(object,...) .residualsModel(object,...)

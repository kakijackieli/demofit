...
#'
#' @export
LCLS <- function(x,t,M,curve=NULL,h=10,jumpoff=1) {
...
#' @export
forecast.LCLS <- function(object,which=1,...) .forecastModel(object,which,...)
...
#' @export
residuals.LCLS <- function(object,...) .residualsModel(object,...)

...
#'
#' @export
PLCS <- function(x,D,E,curve=NULL,h=10,jumpoff=1) {
...
#' @export
forecast.PLCS <- function(object,which=1,...) .forecastModel(object,which,...)
...
#' @export
residuals.PLCS <- function(object,...) .residualsModel(object,...)
